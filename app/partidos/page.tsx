...
export default function PartidosPage() {
  ...
  async function fetchJornadas() {
    ...
    if (jData && jData.length > 0) {
      ...
      const actual =
        jData.find((j) => j.fecha_inicio && j.fecha_inicio >= hoy) ||
        jData[jData.length - 1];
      ...
      <section className="hero-simple glass-bg">
        <div className="container">
          ...
          <p className="hero-subtitle">
            Sigue todos los partidos de la temporada{" "}
            ...
            <>
              ...
              {descansos.length > 0 && (
                <div className="descansos-jornada glass shadow-glare">
                  <span className="descansos-title">
                    Descansan esta jornada
                  </span>
              ...
              <div className="matches-grid">
                {partidos.length > 0 ? (
                  partidos.map((p) => (
                    <div
                      key={p.id}
                      className={`match-card-v2 glass shadow-glare ${p.estado}`}
                    >
                      ...
                      <div className="match-teams-row">
                        <div className="team-box home">
                          <img
                            src={
                              p.equipo_local?.escudo_url ||
                              "/placeholder-shield.png"
                            }
                            alt=""
                            className="team-shield-large"
                          />
                          <span className="team-name-v2">
                      ...
                      <div className="match-footer">
                        ...
                        <span className="stadium-name">
                          {p.campo?.nombre || "Campo por definir"}
                        </span>
                        {p.campo?.poblacion && (
                          <span className="stadium-city">
                            ({p.campo.poblacion})
                          </span>
                        )}
                      </div>
                  ...
                  <div className="no-matches-in-jornada">
                    <p>
                      No hay partidos programados para esta jornada todavía.
                    </p>
                  </div>
                )}
              </div>
