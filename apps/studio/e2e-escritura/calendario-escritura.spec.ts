...
test.describe("con la hora de Madrid", () => {
  // La prueba corre en la zona del club y guarda una hora de invierno (tras el 25/10) para
  // comprobar que el cambio de hora no la mueve.
