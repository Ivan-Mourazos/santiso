 ...
 */
export default function BarraTemporada({ temporadas, seleccionada, onCambiar, deshabilitada }: Props) {
  const actual = temporadas.find((t) => t.id === seleccionada);
  return (
    <div style={{ display: "flex", flexWrap: "wrap", alignItems: "end", gap: "1rem", marginBottom: "1rem" }}>
