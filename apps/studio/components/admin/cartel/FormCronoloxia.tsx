    ...
    <>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          ...
          >
            ...
            >
              <input
                ...
                placeholder="Min'"
                value={ev.minuto}
                onChange={(e) => updateEvent(i, { minuto: e.target.value })}
                style={{
                  ...eventControlStyle,
                  textAlign: "center",
                  padding: "0.45rem",
            ...
            >
              <select
                value={ev.tipo}
                onChange={(e) =>
                  updateEvent(i, { tipo: e.target.value as CronEvent["tipo"], jugadorEntra: "" })
                }
                    ...
                    {ev.equipo === "local" ? (
                      <>
                        ...
                        <select
                          title="Entra"
                          value={
                            jugadores.find((j) => getDisplayName(j) === ev.jugadorEntra)?.id || ""
                          }
                          onChange={(e) => {
                            const jug = jugadores.find((j) => j.id === e.target.value);
        ...
        {form.events.length === 0 && (
          <p
            style={{ color: "#666", fontSize: "0.8rem", textAlign: "center", marginTop: "0.5rem" }}
          >
